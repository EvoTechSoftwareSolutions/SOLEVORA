      ...
      <footer className="footer-area">
        ...
        <div className="footer-main-section">
          ...
          <div className="footer-container legal-bar">
            <div className="legal-links-all">
              <div className="legal-text-group">
                <p className="copyright-inline">© 2026 SoleVora. All rights reserved.</p>
              ...
              <div className="social-links-inline">
                <a href="#" aria-label="Instagram">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><circle cx="12" cy="12" r="4" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>
                </a>
