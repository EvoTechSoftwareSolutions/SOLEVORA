  ...
  return (
    <div className="min-h-screen bg-[#f4f4f4]">
      <div className="flex flex-col min-h-screen md:flex-row">
        ...
        {/* Right Side */}
        <div className="w-full md:w-1/2 bg-[#f4f4f4] flex items-center justify-center px-6 md:px-16 py-12">
          <div className="w-full max-w-lg">
            <h2 className="text-4xl md:text-5xl font-bold text-[#241815] leading-tight">
              Set a new
              <br />
              password
            </h2>

            <p className="mt-6 text-[#6e696d] text-lg leading-9 max-w-md">
